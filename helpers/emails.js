...
const emailOlvidePassword = async (datos) => {
  ...
  await transport.sendMail({
    ...
    <p>Sigue siguiente enlace para generar un password nuevo:
    <a href="${process.env.BACKEND_URL}:${
      process.env.PORT ?? 3000
    }/auth/olvide-password/${token}">Recuperar Cuenta</a></p>
    <p>Si tu no solicitaste la recuperación de contraseña, puedes ignorar el mensaje.</p>
    `,
  });
};
